...
namespace GPRS.Clases
{
    public class Configurations
    {
        ...
        readonly string rutaXml = @"C:\GPRS\Data\Configuration.xml";

        readonly string rutaDir = @"C:\GPRS\Data\";

        private readonly string nodoPrincipal = "Configuration";
        ...
        #region Find
        public bool _FindUdpClient(string name, string nodoP)
        {
            int intent = 0;
            bool action = false;
            while (!action)
        ...
        public bool _FindUdpServer(string name, string nodoP)
        {
            int intent = 0;
            bool action = false;
            while (!action)
        ...
        public bool _FindTcpClient(string name, string nodoP)
        {
        ...
        public bool _FindTcpServer(string name, string nodoP)
        {
            int intent = 0;
            bool action = false;
            while (!action)
        ...
        public bool _FindNodoBeforeDelete(string name,string nodop,string nodos,string nodot,string nodoc)
        {
            int intent = 0;
            bool action = false;
