...
{
    public partial class FormSocketUdpServer : Form
    {
        ...
        bool writting = false;
        readonly UdpServerMessagesModel udpClientMessagesModel = new UdpServerMessagesModel();

        public FormSocketUdpServer(FormServidor formServidor)
        {
            InitializeComponent();
        ...
        private void FormSocketUdpServer_Load(object sender, EventArgs e)
        {

            XmlNodeList listaClients = c._ReadXml("Servers", "Udp", "UdpServer", "Server");
        ...
        private void txtMsg_MouseEnter(object sender, EventArgs e)
        {
            //taskMessage = false;
        }
            ...
            if (!lblName.Text.Equals("Nombre"))
            {
                if (!Session.user.Equals(string.Empty))
                {
                    if (btnSwitchOnOff.IsOn)
                    {
                        ...
                        driverMaster.beginOneUdpServerServer(lblName.Text, txtEnlacePort.Text, txtDestinationPort.Text);
                    ...
                    else
                    {
                        ...
                        driverMaster.closeOneUdpServerS(lblName.Text);
        ...
        private void FormSocketUdpServer_FormClosing(object sender, FormClosingEventArgs e)
        {
            formServidor.countWindows -= 1;
            formServidor.listUdpServerForm.Remove(this);
        }
        ...
        private void chargeBeforeMessage()
        {
            ...
            try
            {
                ...
                //msg = udpClientMessagesModel.readMessages(lblName.Text, "Servers", msg);

                DataTable t = udpClientMessagesModel.readMessages(lblName.Text, "Servers");
                ...
                for (int i = 0; i < t.Rows.Count; i++)
                {
                    ...
                    {
                        msg = "UdpServer " + t.Rows[i][2].ToString() + ": " + t.Rows[i][1].ToString() + "    [" + t.Rows[i][4].ToString() + "   " + t.Rows[i][5].ToString() + "]";
                    }
                    else
                    {
                        msg += "\n" + "UdpServer " + t.Rows[i][2].ToString() + ": " + t.Rows[i][1].ToString() + "    [" + t.Rows[i][4].ToString() + "   " + t.Rows[i][5].ToString() + "]";
                    }
                }
