...
namespace GPRS.Forms
{
    public partial class FormConfiguraciones : Form
    {
        ...
        {
            if (tablaUdpClient.CurrentRow != null)
            {
        ...
        {
            if (tablaUDPServer.CurrentRow != null)
            {
        ...
        {
            if (tablaTcpServer.CurrentRow != null)
            {
        ...
        {
            if (tablaTcpClient.CurrentRow != null)
            {
...
Servidor*/
        ...
        {
            if (tablaTcpServerModem.CurrentRow != null)
            {
        ...
        {
            if (tablaTcpClientModem.CurrentRow != null)
            {
        ...
        {
            if (tablaUdpServerModem.CurrentRow != null)
            {
