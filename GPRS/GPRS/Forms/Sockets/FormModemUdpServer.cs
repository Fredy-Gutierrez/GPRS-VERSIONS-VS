...
{
    public partial class FormModemUdpServer : Form
    {
        Configurations c;
        ...
        {
            XmlNodeList listaClients = c._ReadXml("Modems", "Udp", "UdpServer", "Server");
            ...
            if (!lblName.Text.Equals("Nombre"))
            {
                if (!Session.user.Equals(string.Empty))
                {
                    if (btnSwitchOnOff.IsOn)
                    {
                        ...
                        driverMaster.beginOneUdpServerModem(lblName.Text, txtEnlacePort.Text, txtDestinationPort.Text);
                    ...
                    else
                    {
                        ...
                        driverMaster.closeOneUdpServerM(lblName.Text);
        ...
        private void chargeBeforeMessage()
        {
            try
            {
                ...
                //msg = udpClientMessagesModel.readMessages(lblName.Text, "Modems", msg);
                DataTable t = udpClientMessagesModel.readMessages(lblName.Text, "Modems", msg);
