...
{
    public partial class FormModemTcpClient : Form
    {
        Configurations c;
        ...
        private void FormModemTcpClient_Load(object sender, EventArgs e)
        {
            XmlNodeList listaClients = c._ReadXml("Modems", "Tcp", "TcpClient", "Client");
            ...
            if (!lblName.Text.Equals("Nombre"))
            {
                if (!Session.user.Equals(string.Empty))
                {
                    if (btnSwitchOnOff.IsOn)
                    {
                        ...
                        driverMaster.beginOneTcpClientModem(lblName.Text, txtIp.Text, txtPort.Text);
                    ...
                    else
                    {
                        ...
                        driverMaster.closeOneTcpClientM(lblName.Text);
        ...
        private void chargeBeforeMessage()
        {
            try
            {
                ...
                DataTable t = tcpClientMessagesModel.readMessages(lblName.Text, "Modems", msg);
