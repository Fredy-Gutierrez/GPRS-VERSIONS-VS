...
{
    public partial class FormModemTcpServer : Form
    {
        Configurations c;
        ...
        public FormModemTcpServer(FormServidor formServidor)
        {
            InitializeComponent();
        ...
        {
            formServidor.listTcpServerFormModem.Remove(this);
            this.Close();
        }
        ...
        private void FormModemTcpServer_Load(object sender, EventArgs e)
        {
            XmlNodeList listaClients = c._ReadXml("Modems", "Tcp", "TcpServer", "Server");
            ...
            if (!lblName.Text.Equals("Nombre"))
            {
                if (!Session.user.Equals(string.Empty))
                {
                    if (btnSwitchOnOff.IsOn)
                    {
                        ...
                        driverMaster.beginOneTcpServerModem(lblName.Text, txtPort.Text);
                    ...
                    else
                    {
                        ...
                        driverMaster.closeOneTcpServerM(lblName.Text);
        ...
        private void FormModemTcpServer_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void chargeBeforeMessage()
        {
            try
            {
                ...
                DataTable t = tcpServerMessagesModel.readMessages(lblName.Text, "Modems", msg);
