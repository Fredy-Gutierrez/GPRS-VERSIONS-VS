...
namespace GPRS.Clases
{
    public class Configurations
    {
                        ...
                        case "Udp":
                            switch (nodoT)
                            {
                                case "UdpClient":
                                    ...
                                    {
                                        _UpdateUdpClient(name,ip,enlaceport,destinationport,nodoP);
                                    }
                                    else
                                    {
                                        newNodo = _Create_Udp_Client(name, ip, enlaceport,destinationport);
                                ...
                                case "UdpServer":
                                    ...
                                    {
                                        _UpdateUdpServer(name,enlaceport,destinationport,nodoP);
                                    }
                                    else {
                                        newNodo = _Create_Udp_Server(name, enlaceport, destinationport);
                                        nodoRaiz = doc.DocumentElement.SelectSingleNode(nodoP).SelectSingleNode(nodoS).SelectSingleNode(nodoT);
                                        nodoRaiz.InsertAfter(newNodo, nodoRaiz.LastChild);
                                        doc.Save(rutaXml);
                                    }
                        ...
                        case "Tcp":
                            switch (nodoT)
                            {
                                case "TcpClient":
                                    ...
                                    {
                                        _UpdateTcpClient(name,ip,port,nodoP);
                                    }
                                    else
                                    {
                                        newNodo = _Create_Tcp_Client(name, ip, port);
                                        nodoRaiz = doc.DocumentElement.SelectSingleNode(nodoP).SelectSingleNode(nodoS).SelectSingleNode(nodoT);
                                        nodoRaiz.InsertAfter(newNodo, nodoRaiz.LastChild);
                                        doc.Save(rutaXml);
                                    }
                                ...
                                case "TcpServer":
                                    ...
                                    {
                                        _UpdateTcpServer(name,port,nodoP);
                                    }
                                    else
                                    {
                                        newNodo = _Create_Tcp_Server(name, port);
                                        nodoRaiz = doc.DocumentElement.SelectSingleNode(nodoP).SelectSingleNode(nodoS).SelectSingleNode(nodoT);
                                        nodoRaiz.InsertAfter(newNodo, nodoRaiz.LastChild);
                                        doc.Save(rutaXml);
                                    }
        ...
        #region create
        private XmlNode _Create_Udp_Client( string name, string ip, string port,string destinationport)
        {
        ...
        private XmlNode _Create_Udp_Server(string name, string enlaceport, string destinationport)
        {
        ...
        private XmlNode _Create_Tcp_Client(string name, string ip, string port)
        {
        ...
        private XmlNode _Create_Tcp_Server(string name, string port)
        {

            XmlNode client = doc.CreateElement("Server");
        ...
        #region Update
        public void _UpdateUdpClient(string name, string ip, string port,string destinationport,string nodoP)
        {
            ...
            XmlNode nuevo_ClientUdp = _Create_Udp_Client(name,ip,port,destinationport);
        ...
        public void _UpdateUdpServer(string name, string enlaceport, string destinationport, string nodoP)
        {
            ...
            XmlNode nuevo_ServerUdp = _Create_Udp_Server(name, enlaceport, destinationport);
        ...
        public void _UpdateTcpClient(string name, string ip, string port, string nodoP)
        {
            ...
            XmlNode nuevo_ClientTcp = _Create_Tcp_Client(name, ip, port);
        ...
        public void _UpdateTcpServer(string name, string port,string nodoP)
        {
            ...
            XmlNode nuevo_ServerTcp = _Create_Tcp_Server(name, port);
